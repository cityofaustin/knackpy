...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knackpy/flexsearch.min.js');loadScript('/knackpy/en.search-data.min.6502bc3c4f303e2ce47f6db7684e7aa0d8dcbdea9a44be9d1403d20c1a3dd3db.js',function(){input.required=false;search();});}
