...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knackpy/flexsearch.min.js');loadScript('/knackpy/en.search-data.min.ea495dda2afe5f491aa19fd4f9331950b7798757e2134c2a99f71f0d53516efa.js',function(){input.required=false;search();});}
