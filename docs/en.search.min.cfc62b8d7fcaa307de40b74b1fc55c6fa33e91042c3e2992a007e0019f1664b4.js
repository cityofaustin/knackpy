...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knackpy/flexsearch.min.js');loadScript('/knackpy/en.search-data.min.00eee4fe9ce4c7cb813c636c436c325f223ebf0d0793a669a1b13da85aafff76.js',function(){input.required=false;search();});}
