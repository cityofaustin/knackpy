...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knackpy/flexsearch.min.js');loadScript('/knackpy/en.search-data.min.8e6287ea4e4436bc6dfac6b3bc911cb1c09d2d4a11bd56bdf83da99f184cd149.js',function(){input.required=false;search();});}
