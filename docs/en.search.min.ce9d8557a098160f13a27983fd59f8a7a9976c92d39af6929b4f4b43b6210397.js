...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knackpy/flexsearch.min.js');loadScript('/knackpy/en.search-data.min.8f38466e4b5e8940aba0ebc3abd0629de44905c8ba6a3f3a8d63518e60ced39a.js',function(){input.required=false;search();});}
