TIMEZONES = [
    ...
    {"common_name": "Guadalajara,Mexico City, Monterrey" ,"iana_name": "America/Mexico_City"},
    ...
    {"common_name": "Georgetown, La Paz, Manaus, San Juan" ,"iana_name": "America/La_Paz"},
    ...
    {"common_name": "Greenwich Mean Time : Dublin, Edinburgh, Lisbon, London" ,"iana_name": "Europe/London"},
    {"common_name": "Sarajevo,Skopje, Warsaw, Zagreb" ,"iana_name": "Europe/Warsaw"},
    {"common_name": "West Central Africa" ,"iana_name": "Africa/Lagos"},
    {"common_name": "Belgrade,Bratislava, Budapest, Ljubljana, Prague" ,"iana_name": "Europe/Budapest"},
    {"common_name": "Brussels, Copenhagen,Madrid, Paris" ,"iana_name": "Europe/Paris"},
    {"common_name": "Amsterdam,Berlin, Bern, Rome,Stockholm, Vienna" ,"iana_name": "Europe/Berlin"},
    {"common_name": "Harare, Pretoria" ,"iana_name": "Africa/Johannesburg"},
    {"common_name": "Damascus" ,"iana_name": "Asia/Damascus"},
    {"common_name": "Helsinki, Kyiv, Riga, Sofia, Tallinn, Vilnius" ,"iana_name": "Europe/Kiev"},
    ...
    {"common_name": "Beijing,Chongqing,Hong Kong, Urumqi" ,"iana_name": "Asia/Shanghai"},
    ...
    {"common_name": "Phoenix Islands, Tokelau, Tonga" ,"iana_name": "Pacific/Enderbury"},
